"""
Task4_1_1 Random Forest双路径输入对比实验
训练集: 0.5, 测试集: 0.35
"""
import os
import sys
...
def main():
    """主函数"""
    print("开始Task4_1_1 Random Forest双路径输入对比实验")
    ...
    # 训练和评估Random Forest
    results = train_and_evaluate_random_forest(X_train, X_test, y_train, y_test, 'dual_path', '05_to_035', output_dir)
    
    # 创建汇总CSV
    print(f"\n创建汇总结果...")
    create_summary_csv(output_dir)
    
    print(f"\nTask4_1_1 Random Forest双路径输入对比实验完成!")
