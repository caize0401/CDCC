...
def main():
    """主函数"""
    print("开始Task4_1_1 H2O AutoML双路径输入对比实验")
    ...
    # 训练和评估H2O AutoML
    results = train_and_evaluate_h2o_automl(X_train, X_test, y_train, y_test, 'dual_path', '05_to_035', output_dir)
    
    # 创建汇总CSV
    print(f"\n创建汇总结果...")
    create_summary_csv(output_dir)
    
    print(f"\nTask4_1_1 H2O AutoML双路径输入对比实验完成!")
