...
def run_all_experiments():
    ...
    output_dir = Path(__file__).resolve().parent / '035_to_05'
    ...
    df_train_raw = datasets['data1']['035']   # 训练：0.35
    df_test_raw = datasets['data1']['05']     # 测试：0.5
    ...
    df_train_raw = datasets['data1']['035']   # 原始信号
    df_train_feat = datasets['data2']['035']  # 完整特征
    df_test_raw = datasets['data1']['05']     # 原始信号
    df_test_feat = datasets['data2']['05']    # 完整特征
