...
运行所有跨域实验的主脚本
包括：
1. 0.5数据集训练，0.35数据集测试 (v4 + v5)
2. 0.35数据集训练，0.5数据集测试 (v4 + v5)
...
def main():
    """主函数"""
    print("开始运行task4_4跨域实验")
    print("使用v4 (Transformer) 和 v5 (HybridFusion Pro) 模型进行跨域测试")
    ...
    experiments = [
        ("run_05_to_035_experiment.py", "0.5数据集训练 → 0.35数据集测试 (v4 + v5)"),
        ("run_035_to_05_experiment.py", "0.35数据集训练 → 0.5数据集测试 (v4 + v5)"),
    ]
