...
def main():
    """主函数"""
    print("开始Task4_2_1 XGBoost双路径输入对比实验")
    ...
    # 训练和评估XGBoost
    results = train_and_evaluate_xgboost(X_train, X_test, y_train, y_test, 'dual_path', '035_to_05', output_dir)
    
    # 创建汇总CSV
    print(f"\n创建汇总结果...")
    create_summary_csv(output_dir)
    
    print(f"\nTask4_2_1 XGBoost双路径输入对比实验完成!")
